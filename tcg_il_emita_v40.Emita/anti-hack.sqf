...
hintc "You need to be on TS3:ffg.ts3dns.com\nAll cops must be on teamspeak to play\nAll Cops must have a Taser on them\nRandom and Vehicle deathmatch is a bannable offence\nDon't spam global and be respectful to all players\nADMINS HAVE THE FINAL SAY\nAlso remember to roleplay.\nWWW.FASTFORWARDGAMING.NET";
...
if (!naughty) exitWith {
	...
	player sidechat "Welcome to FFG! WWW.FASTFORWARDGAMING.NET";
};
