...
if(_copcount < 5)exitwith{player groupchat "You need 5 police officers to raid this safe!"};
if(local_cash < 50000)exitwith{player groupchat "this safe has recently been confiscated from and is empty"};
