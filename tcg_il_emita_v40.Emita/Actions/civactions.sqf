...
actionpmc = _role addaction ["Switch to PMC Clothes","noscript.sqf",'["Soldier_Bodyguard_AA12_PMC"] call clothes;',1,true,true,"",'player distance pmc < 10 and ("pmcl" call INV_HasLicense)'];
