...
class gang_menu
{
	...
	class button_manage : RscButton
	{
		...
		action = "[0, 0, 0, [""gildenverwaltung""]] spawn civ_gangcontrol; closedialog 0;";
	};
...
class CopMenu
{
	...
	class button1 : RscButton
	{
		...
		action = "closedialog 0; [0,1,2,[""wantedrelease""]] spawn jail_release;";
	};
	...
	{							
		...
		text = "Crime log";	
		action = "closedialog 0; [0,1,2,[""coplog""]] spawn cop_coplog;";	
	};
