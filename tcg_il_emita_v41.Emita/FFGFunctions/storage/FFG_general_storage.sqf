...
buttonSetAction [3,   format['if ((lbCurSel 1) >= 0) then {["nehmen",  "%1", ctrlText 2, (lbData [1, (lbCurSel 1)]),"%3", %2] call storage_add; closedialog 0; [0,0,0,["%1", "%3", %2]] spawn storage_unit;};', _arrname, _extra, _public] ];
buttonSetAction [103, format['if ((lbCurSel 101) >= 0) then {["ablegen", "%1", ctrlText 102, (lbData [101, (lbCurSel 101)]), "%3", %2] call storage_add; closedialog 0; [0,0,0,["%1", "%3", %2]] spawn storage_unit;};', _arrname, _extra, _public] ];
